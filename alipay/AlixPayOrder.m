...
- (NSString *)description {
	...
	[discription appendFormat:@"&notify_url=\"%@\"", self.notifyURL ? self.notifyURL : @"http://api.niceroad.com.cn/api/notify_url.aspx"];
	...
	//[discription appendFormat:@"&return_url=\"%@\"", self.returnUrl ? self.returnUrl : @"http://api.niceroad.com.cn/api/alipay_return.aspx"];
