    ...
    if(self.dataSource.count > indexPath.row)
    {
        ...
        if (entity) {
            ...
            else if (applyStyle == ApplyStyleJoinGroup)
            {
                ...
                //设置头像和昵称
                NSString *getUserName = entity.applicantUsername;
                ...
                cell.titleLabel.text = getNickName;
                ...
                [cell.headerImageView sd_setImageWithURL: [NSURL URLWithString:getHeadImage] placeholderImage:[UIImage imageNamed:@"chatListCellHead.png"]];
