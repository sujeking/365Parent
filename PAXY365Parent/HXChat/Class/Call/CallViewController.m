...
- (void)viewDidLoad {
    ...
    [_headerImageView sd_setImageWithURL: [NSURL URLWithString:getHeadImage] placeholderImage:[UIImage imageNamed:@"chatListCellHead.png"]];
