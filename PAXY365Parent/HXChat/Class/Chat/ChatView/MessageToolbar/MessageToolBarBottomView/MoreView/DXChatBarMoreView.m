...
- (void)setupSubviewsForType:(ChatMoreType)type
{
    ...
    lblPhoto.frame = CGRectMake(insets, 10, CHAT_BUTTON_SIZE, CHAT_BUTTON_SIZE + 70 );
    lblPhoto.font = [UIFont systemFontOfSize:14];
    ...
    lblLocation.frame = CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE + 70);
    ...
    UILabel *lblTakePicture = [[UILabel alloc] init];
    lblTakePicture.frame = CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE + 70);
    lblTakePicture.font = [UIFont systemFontOfSize:14];
    lblTakePicture.textColor = [UIColor blackColor];
    lblTakePicture.backgroundColor = [UIColor clearColor];
    lblTakePicture.textAlignment = NSTextAlignmentCenter;
    lblTakePicture.text = @"拍照";
    [self addSubview:lblTakePicture];
    ...
    if (type == ChatMoreTypeChat) {
        ...
        lblAudio.frame = CGRectMake(insets * 4 + CHAT_BUTTON_SIZE * 3, 10, CHAT_BUTTON_SIZE + 10, CHAT_BUTTON_SIZE + 75);
        lblAudio.font = [UIFont systemFontOfSize:14];
        lblAudio.textColor = [UIColor blackColor];
        lblAudio.backgroundColor = [UIColor clearColor];
        lblAudio.textAlignment = NSTextAlignmentCenter;
        lblAudio.text = @"语音电话";
        [self addSubview:lblAudio];
        ...
        UILabel *lblVideo = [[UILabel alloc] init];
        lblVideo.frame =CGRectMake(insets, 10 * 2 + CHAT_BUTTON_SIZE + 10, CHAT_BUTTON_SIZE + 10, CHAT_BUTTON_SIZE + 75);
        lblVideo.font = [UIFont systemFontOfSize:14];
        lblVideo.textColor = [UIColor blackColor];
        lblVideo.backgroundColor = [UIColor clearColor];
        lblVideo.textAlignment = NSTextAlignmentCenter;
        lblVideo.text = @"视频电话";
        [self addSubview:lblVideo];
    }
