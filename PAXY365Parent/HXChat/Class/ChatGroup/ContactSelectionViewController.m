...
- (void)reloadFooterView
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        //[remarkView.image sd_setImageWithURL: [NSURL URLWithString:getHeadImage] placeholderImage:[UIImage imageNamed:@"chatListCellHead.png"]];
        remarkView.image = [UIImage imageNamed:@"chatListCellHead.png"];
        remarkView.remark = getNickName;
