...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[ContactsEntity class]])
    {
        ...
        NSString *getID = data.UserID;
        NSString *getName = data.NickName;
        ...
        [defaults setObject:getID forKey:@"cloudin_365paxy_selected_contactsid"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selected_contactsname"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selectedtemp_contactsname"];
...
-(void) sendGetDatas
{
    ...
    if (defaults)
    {
        ...
        getKeywords = [defaults objectForKey:@"cloudin_365paxy_keywords_contacts"];
    }
    ...
    NSString *getCurrentUrl=[NSString stringWithFormat:@"%@?keywords=%@&sid=%@&cid=%@&gid=%@&flag=%@",ContactsListUrl,getKeywords,getSchoolID,getClassID,getGradeID,setFlag];
...
-(void) loadmore:(UIButton *) sender
{
    ...
    NSString *pageUrl = [NSString stringWithFormat:@"%@?PageSize=20&Page=%d&keywords=%@&sid=%@&cid=%@&gid=%@&flag=%@",ContactsListUrl,currentPage,getKeywords,getSchoolID,getClassID,getGradeID,setFlag];
