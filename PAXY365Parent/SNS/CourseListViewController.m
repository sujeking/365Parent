...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[CourseEntity class]])
    {
        ...
        NSString *getID = data.CourseID;
        NSString *getName = data.CourseName;
        ...
        [defaults setObject:getID forKey:@"cloudin_365paxy_selected_courseid"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selected_coursename"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selectedtemp_coursename"];
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[CourseEntity class]])
    {
        ...
        CourseCell *cell  = (CourseCell *)[self.tableView dequeueReusableCellWithIdentifier:identifier];
        
        if (cell == nil)
        {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"CourseCell" owner:self options:nil] objectAtIndex:0];
            cell.selectionStyle = UITableViewCellSelectionStyleBlue;
        }
        
        CourseEntity *news = (CourseEntity *)object;
        cell.object = news;
...
-(void) sendGetDatas
{
    ...
    NSString *getCurrentUrl=[NSString stringWithFormat:@"%@?flag=%@&keywords=%@",CourseListUrl,setFlag,setKeywords];
...
-(void) loadmore:(UIButton *) sender
{
    ...
    NSString *pageUrl = [NSString stringWithFormat:@"%@?PageSize=20&Page=%d&flag=%@&keywords=%@",CourseListUrl,currentPage,setFlag,setKeywords];
...
-(void) netFinish:(NSDictionary *)jsonString withUserInfo:(NSDictionary *)userInfo
{
    ...
    if (jsonString)
    {
        temparray = [ParseJson getCourseList:jsonString];
    }
