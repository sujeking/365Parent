...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[MessageEntity class]])
    {
        ...
        static NSString *identifier1 = @"HomeworkCell2";
        
        HomeworkCell *cell  = nil;
        MessageEntity *data = (MessageEntity *) object;
        NSString *getDate = data.AddDate;
        if ([getDate isEqualToString:@"1"]) {
            //隐藏日期
            cell  = (HomeworkCell *)[self.tableView dequeueReusableCellWithIdentifier:identifier0];
        }
        else{
            cell  = (HomeworkCell *)[self.tableView dequeueReusableCellWithIdentifier:identifier1];
        }
        ...
        if (cell == nil)
        {
            ...
            if ([getDate isEqualToString:@"1"]) {
                ...
                cell = [[[NSBundle mainBundle] loadNibNamed:@"HomeworkCellTwo" owner:self options:nil] objectAtIndex:0];
...
-(void) sendGetDatas
{
    ...
    if (defaults)
    {
        ...
        getKeyword = [defaults objectForKey:@"cloudin_365paxy_keywords_homework"];
    }
