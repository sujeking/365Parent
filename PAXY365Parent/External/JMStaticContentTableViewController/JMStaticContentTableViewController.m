...
- (void) viewDidLoad {
    ...
    //self.tableView.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"main_bg.png"]];
...
- (void) setFooterText:(NSString *)footerTextValue {
	...
	if([self isViewLoaded]) {
		...
		footerLabel.textColor = [UIColor colorWithRed:164/255.0 green:170/255.0 blue:173/255.0 alpha:1.0];
