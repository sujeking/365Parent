...
-(void) sendGetDatas
{
    ...
    NSString *getCurrentUrl=[NSString stringWithFormat:@"%@?uid=%@&flag=%@&type=%@",QuestionListUrl,getUserID,getFlag,getType];
...
-(void) loadmore:(UIButton *) sender
{
    ...
    NSString *pageUrl = [NSString stringWithFormat:@"%@?PageSize=20&Page=%d&uid=%@&flag=%@&type=%@",QuestionListUrl,currentPage,getUserID,getFlag,getType];
