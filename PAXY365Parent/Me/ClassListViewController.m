...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[ClasssEntity class]])
    {
        ...
        [defaults setObject:getID forKey:@"cloudin_365paxy_selected_classid"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selected_classname"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selectedtemp_classname"];
...
-(void) sendGetDatas
{
    ...
    NSString *getCurrentUrl=[NSString stringWithFormat:@"%@?flag=%@&keywords=%@",ClassListUrl,setFlag,getKeywords];
...
-(void) loadmore:(UIButton *) sender
{
    ...
    NSString *pageUrl = [NSString stringWithFormat:@"%@?PageSize=20&Page=%d&flag=%@&keywords=%@",ClassListUrl,currentPage,setFlag,getKeywords];
