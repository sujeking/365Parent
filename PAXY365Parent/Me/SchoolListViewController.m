...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[SchoolEntity class]])
    {
        ...
        NSString *getID = data.SchoolID;
        NSString *getName = data.SchoolName;
        ...
        [defaults setObject:getID forKey:@"cloudin_365paxy_selected_schoolid"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selected_schoolname"];
        [defaults setObject:getName forKey:@"cloudin_365paxy_selectedtemp_schoolname"];
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[SchoolEntity class]])
    {
        ...
        SchoolCell *cell  = (SchoolCell *)[self.tableView dequeueReusableCellWithIdentifier:identifier];
        ...
        SchoolEntity *news = (SchoolEntity *)object;
        cell.object = news;
...
-(void) sendGetDatas
{
    ...
    if (defaults){
        ...
        getKeywords = [defaults objectForKey:@"cloudin_365paxy_keywords_school"];
    ...
    NSString *getCurrentUrl=[NSString stringWithFormat:@"%@?flag=%@&keywords=%@&pid=%@&cid=%@&did=%@",SchoolListUrl,setFlag,getKeywords,getProvinceID,getCityID,getDistrictID];
...
-(void) loadmore:(UIButton *) sender
{
    ...
    NSString *pageUrl = [NSString stringWithFormat:@"%@?PageSize=20&Page=%d&flag=%@&keywords=%@&pid=%@&cid=%@&did=%@",SchoolListUrl,currentPage,setFlag,getKeywords,getProvinceID,getCityID,getDistrictID];
...
-(void) netFinish:(NSDictionary *)jsonString withUserInfo:(NSDictionary *)userInfo
{
    ...
    if (jsonString)
    {
        temparray = [ParseJson getSchoolList:jsonString];
    }
...
- (void)updateSearchString:(NSString*)searchString
{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setObject:searchString forKey:@"cloudin_365paxy_keywords_school"];
