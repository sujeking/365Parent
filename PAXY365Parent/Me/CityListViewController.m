...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[CityEntity class]])
    {
        ...
        NSString *getCity = data.cityName;
        ...
        titleLabel.text = getCity;
        titleLabel.textAlignment = NSTextAlignmentCenter;
        self.navigationItem.titleView = titleLabel;
        
        NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
        [defaults setObject:getCity forKey:@"cloudin_niceroad_selectedcity"];
...
-(void) sendGetDatas
{
    ...
    if (standardUserDefaults){
        getKeywords = [standardUserDefaults objectForKey:@"cloudin_niceroad_keywords"];
    }
    ...
    NSString *getCurrentUrl=[NSString stringWithFormat:@"%@?keyword=%@",CityListUrl,getKeywords];
...
-(void) loadmore:(UIButton *) sender
{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    if (defaults){
        getKeywords = [defaults objectForKey:@"cloudin_niceroad_keywords"];
    }
    ...
    NSString *pageUrl = [NSString stringWithFormat:@"%@?PageSize=20&Page=%d&keyword=%@",CityListUrl,currentPage,getKeywords];
...
- (void)updateSearchString:(NSString*)searchString
{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setObject:searchString forKey:@"cloudin_niceroad_keywords"];
