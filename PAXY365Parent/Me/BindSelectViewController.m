...
@interface BindSelectViewController ()

@end

@implementation BindSelectViewController
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[BindEntity class]])
    {
        ...
        NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
        [defaults setObject:data.SchoolID forKey:@"cloudin_365paxy_schoolid"];
        [defaults setObject:data.ClassID forKey:@"cloudin_365paxy_classid"];
        [defaults setObject:data.GradeID forKey:@"cloudin_365paxy_gradeid"];
        [defaults setObject:data.ClassName forKey:@"cloudin_365paxy_to_classname"];
        ...
        if ([getGotoFlag isEqualToString:@"1"]) {
            ...
            [defaults setObject:@"1" forKey:@"cloudin_365paxy_message_changeclass"];
            [self closeView];
        }
